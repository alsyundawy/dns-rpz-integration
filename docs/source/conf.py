...
changelog_render_ticket = "https://github.com/spirillen/dns-rpz-integration/issues/%s"
changelog_render_pullreq = "https://github.com/spirillen/dns-rpz-integration/pull/%s"
changelog_render_changeset = "https://github.com/spirillen/dns-rpz-integration/commit/%s"
...
html_theme_options = {
    ...
    "headbgcolor": "darkgrey",
    "headtextcolor": "limegreen",
...
htmlhelp_basename = 'IntegrationofDNSRPZdoc'
...
man_pages = [
    (master_doc, 'integrationofdnsrpz', 'Integration of DNS RPZ Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'IntegrationofDNSRPZ', 'Integration of DNS RPZ Documentation',
     author, 'IntegrationofDNSRPZ', 'One line description of project.',
     'Miscellaneous'),
]
